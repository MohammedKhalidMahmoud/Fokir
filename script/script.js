        ...
        const counterElement_1 = document.getElementById('counter1');
        const counterElement_2 = document.getElementById('counter2');
        const counterElement_3 = document.getElementById('counter3');
        const counterElement_4 = document.getElementById('counter4');
